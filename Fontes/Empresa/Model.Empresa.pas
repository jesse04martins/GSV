...
begin
   ...
   if (RazaoSocial.Length > 50) then
       raise Exception.Create('Não é permitido a Razão Social com mais 50 carácteres!');

   if (FNomeFantasia.IsEmpty) then
       raise Exception.Create('Nome de fsntasia é obrigatório!');

   if (FNomeFantasia.Length > 50) then
       raise Exception.Create('Não é permitido o nome de fantasia com mais 50 carácteres!');
end;
