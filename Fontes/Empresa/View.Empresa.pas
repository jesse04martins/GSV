...
begin
    if (PossueDadosNoDataSet = False) then begin
        Exit;
    end;
...
function TFrmEmpresa.PossueDadosNoDataSet: Boolean;
begin
    Result := False;
    ...
    if (DBGrid1.DataSource.DataSet.RecordCount = 0) then begin
        Application.MessageBox('Nenhuma empresa cadastrada!', 'Aviso', MB_ICONEXCLAMATION);
        Exit;
    end;
