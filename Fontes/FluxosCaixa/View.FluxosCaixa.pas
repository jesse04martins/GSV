...
procedure TfrmFluxosCaixa.btExcluirClick(Sender: TObject);
begin
   try
      (FDao as IDaoAtulizarDados<TModelFluxosCaixa>).Excluir(DataSource1.DataSet.FieldByName('id_plano').AsInteger);
...
begin
   ...
   (*
       IPreencherLista<T> = interface
        procedure Preencher(value : iDaoRetornarDados);
